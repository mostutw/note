            ...
            <form role="form" action="{{ url($url) }}" method="post">
                ...
                <div class="col-sm-12 form-column">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control form-select" name="info_colorPerception"
                                ...
                                @foreach ($select_list['info_colorPerception'] as $key => $value)
                                    @if ($query['info_colorPerception'] == $key)
                                        <option value="{{ $key }}" selected>{{ $value }}</option>
                                    @else
                                        <option value="{{ $key }}">{{ $value }}</option>
                                    @endif
                    ...
                    @for ($i = 0; $i < 6; $i++)
                        <div class="row">
                            ...
                            <div class="form-group col-md-5">
                                <label for="exp_leaveReason">{{ trans('resume.exp_leaveReson') }}</label>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select class="form-control form-select" name="feature_englishLevel"
                                ...
                                @foreach ($select_list['feature_englishLevel'] as $key => $value)
                                    @if ($query['feature_englishLevel'] == $key)
                                        <option value="{{ $key }}" selected>{{ $value }}</option>
                                    @else
                                        <option value="{{ $key }}">{{ $value }}</option>
                                    @endif
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select class="form-control form-select" name="feature_taiwaneseHokkienLevel"
                                ...
                                @foreach ($select_list['feature_taiwaneseHokkienLevel'] as $key => $value)
                                    @if ($query['feature_taiwaneseHokkienLevel'] == $key)
                                        <option value="{{ $key }}" selected>{{ $value }}</option>
                                    @else
                                        <option value="{{ $key }}">{{ $value }}</option>
                                    @endif
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select class="form-control form-select" name="other_hospitalized"
                                ...
                                @foreach ($select_list['other_hospitalized'] as $key => $value)
                                    @if ($query['other_hospitalized'] == $key)
                                        <option value="{{ $key }}" selected>{{ $value }}</option>
                                    @else
                                        <option value="{{ $key }}">{{ $value }}</option>
                                    @endif
                        ...
                        <div class="form-group col-md-6">
                            <label
                                for="other_hospitalizedReason">{{ trans('resume.other_hospitalizedReson') }}</label>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8">
                            <label for="other_lawReason">{{ trans('resume.other_lawReson') }}</label>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8">
                            <label for="other_bankReason">{{ trans('resume.other_bankReson') }}</label>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select class="form-control form-select" name="other_workOvertime"
                                ...
                                @foreach ($select_list['other_workOvertime'] as $key => $value)
                                    @if ($query['other_workOvertime'] == $key)
                                        <option value="{{ $key }}" selected>{{ $value }}</option>
                                    @else
                                        <option value="{{ $key }}">{{ $value }}</option>
                                    @endif
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select class="form-control form-select" name="other_workOvertimeHoliday"
                                ...
                                @foreach ($select_list['other_workOvertimeHoliday'] as $key => $value)
                                    @if ($query['other_workOvertimeHoliday'] == $key)
                                        <option value="{{ $key }}" selected>{{ $value }}</option>
                                    @else
                                        <option value="{{ $key }}">{{ $value }}</option>
                                    @endif
                    ...
                    <div class="row">
                        <div class="form-check col-md-12 text-center">
                            <input class="form-check-input" type="checkbox" name="other_promise" id="other_promise"  value="1" @if ($query['other_promise']) checked="checked" @endif required>
